...
inline ::PROTOBUF_NAMESPACE_ID::uint64 uptradebatch_Trades::_internal_price() const {
  return price_;
}
inline ::PROTOBUF_NAMESPACE_ID::uint64 uptradebatch_Trades::price() const {
  // @@protoc_insertion_point(field_get:ukex.uptradebatch.Trades.price)
  return _internal_price();
}
inline void uptradebatch_Trades::_internal_set_price(::PROTOBUF_NAMESPACE_ID::uint64 value) {
  _has_bits_[0] |= 0x00000002u;
  price_ = value;
}
inline void uptradebatch_Trades::set_price(::PROTOBUF_NAMESPACE_ID::uint64 value) {
...
inline ::PROTOBUF_NAMESPACE_ID::uint64 uptradebatch_Trades::_internal_num() const {
  return num_;
}
inline ::PROTOBUF_NAMESPACE_ID::uint64 uptradebatch_Trades::num() const {
  // @@protoc_insertion_point(field_get:ukex.uptradebatch.Trades.num)
  return _internal_num();
}
inline void uptradebatch_Trades::_internal_set_num(::PROTOBUF_NAMESPACE_ID::uint64 value) {
  _has_bits_[0] |= 0x00000004u;
  num_ = value;
}
inline void uptradebatch_Trades::set_num(::PROTOBUF_NAMESPACE_ID::uint64 value) {
