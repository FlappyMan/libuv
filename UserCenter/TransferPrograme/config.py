...
class Config(object):
    ...
    def getConfigInfo(self):
        ...
        UkexPaydatabase = config.get('UKEXPay Database iniPath', 'filePath')
        ...
        tradeDBdatabase = config.get('trade Database iniPath', 'filePath')
        ...
        # 读取UkexPay的数据库
        UkexPayConfigDB = ConfigParser.ConfigParser()
        UkexPayConfigDB.read(UkexPaydatabase)
        self.UkexPay_dbAddress = UkexPayConfigDB.get('DBADDRESS', 'DBADDRESS')
        self.UkexPay_dbPort = UkexPayConfigDB.get('PORT', 'PORT')
        self.UkexPay_userName = UkexPayConfigDB.get('USERNAME', 'USERNAME')
        self.UkexPay_password = UkexPayConfigDB.get('PASSWORD', 'PASSWORD')
        self.UkexPay_dbName = UkexPayConfigDB.get('DBNAME', 'DBNAME')
        ...
        # 读取new的数据库
        tradeDBConfigDB = ConfigParser.ConfigParser()
        tradeDBConfigDB.read(tradeDBdatabase)
        self.tradeDB_dbAddress = tradeDBConfigDB.get('DBADDRESS', 'DBADDRESS')
        self.tradeDB_dbPort = tradeDBConfigDB.get('PORT', 'PORT')
        self.tradeDB_userName = tradeDBConfigDB.get('USERNAME', 'USERNAME')
        self.tradeDB_password = tradeDBConfigDB.get('PASSWORD', 'PASSWORD')
        self.tradeDB_dbName = tradeDBConfigDB.get('DBNAME', 'DBNAME')